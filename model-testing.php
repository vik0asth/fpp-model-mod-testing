...
if(isset($_POST['updatePlugin']))
{
    ...
    $updateResult = updatePluginFromGitHub($gitURL, $branch="master", $pluginName, false);
...
foreach ($my_models as $model) {
    ...
    printf('<td><button type="submit" name="model" value="%s">%s</button></td>', htmlspecialchars($model), htmlspecialchars($model));
